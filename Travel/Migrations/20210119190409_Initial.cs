    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DestinationAccomodationId = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    DestinationId = table.Column<int>(nullable: false),
                    AccomodationId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DestinationAccomodation", x => x.DestinationAccomodationId);
                    table.ForeignKey(
                        name: "FK_DestinationAccomodation_Accomodations_AccomodationId",
                        column: x => x.AccomodationId,
                        principalTable: "Accomodations",
                        principalColumn: "AccomodationId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DestinationAccomodation_Destinations_DestinationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DestinationActivityId = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    DestinationId = table.Column<int>(nullable: false),
                    ActivityId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DestinationActivity_Activities_ActivityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DestinationAccomodation_AccomodationId",
                table: "DestinationAccomodation",
                column: "AccomodationId");

            migrationBuilder.CreateIndex(
                name: "IX_DestinationAccomodation_DestinationId",
                table: "DestinationAccomodation",
                column: "DestinationId");

            migrationBuilder.CreateIndex(
                name: "IX_DestinationActivity_ActivityId",
